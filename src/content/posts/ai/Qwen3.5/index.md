...
![修改LM读取大模型的路径](./images/models_file_path.png)
...
跑起来之后能玩的花样也不少。比如拿 [SillyTavern（酒馆）](/posts/recommend/sillytavern/)当前端，连上 LM Studio 的本地接口搞 AI 角色对话，部署教程我写过一篇。
