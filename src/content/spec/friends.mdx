...
export const site = {
  ...
  desc: "生命不息，折腾不止",
  url: "https://9ll.uk",
  avatar: "https://weavatar.com/api/avatar/e3298b871864a7a21690863f8c930754a36cb5c6f0b105f4b5d4737bfd219f57?s=2000&t=1783684315863",
  email: "admin@9ll.uk",
  rss: "https://www.9ll.uk/rss.xml",
  homepage: "https://www.9ll.uk/gallery/blog/homepage.png",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-2.5 flex-1">
          {[
            ...
            { label: "RSS 链接", value: site.rss },
            { label: "首页照片", value: site.homepage },
          ].map((item) => (
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">申请模板，把内容复制修改后到评论区或邮件中发送。RSS 链接和首页照片为选填项：RSS 用于与本站朋友圈联动；首页照片可选，用于展示网站首页截图</p>
